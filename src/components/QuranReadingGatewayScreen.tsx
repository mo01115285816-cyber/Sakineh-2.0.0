...
export default function QuranReadingGatewayScreen({
  onReadSurah,
  onModeChange,
}: Props) {
      ...
      <div className="fixed top-6 left-6 right-6 h-10 flex flex-row items-center justify-between flex-nowrap z-40 pointer-events-none">
        ...
        <div className="relative shrink-0 h-10 flex items-center pointer-events-auto">
          ...
          >
            ...
            <ChevronDown
              size={14}
              className={`text-[#b88a4f] transition-transform duration-200 ${isFilterDropdownOpen ? "rotate-180" : ""}`}
            />
          </button>
          ...
          <div className="bg-[#f2ebd9]/90 backdrop-blur-md p-1 rounded-full flex gap-1 border border-[#e6dccf] w-full max-w-[280px] shadow-sm">
            <button
              ...
              className={`flex-1 py-1.5 text-[14px] font-bold rounded-full transition-all duration-300 relative ${
                activeTab === "surahs"
                  ? "bg-[#b88a4f] text-white shadow-sm font-bold"
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-center shrink-0 gap-1 md:gap-1.5 ml-0.5 md:ml-1">
                        {/* Metadata: Type | Page */}
                        <span className="text-[7.5px] md:text-[8px] text-[#8a7662] font-bold whitespace-nowrap select-none font-sans pt-[1.5px] mr-1 md:mr-2">
                          {surah.type === "مكية" ? "مكية" : "مدنية"}
                          <span className="mx-0.5 md:mx-1 opacity-30 font-normal">
                            |
                          </span>
                        ...
                        <div className="bg-[#b88a4f]/10 text-[#b88a4f] rounded-full px-2 h-[20px] flex items-center justify-center text-[7.5px] md:text-[8px] font-bold whitespace-nowrap select-none font-sans shadow-sm -mt-[1px]">
                        ...
                        <ChevronLeft
                          size={14}
                          className="text-[#7f6a55]/60 group-hover:text-[#b88a4f] group-hover:-translate-x-0.5 transition-all duration-200 shrink-0 ml-[-2px] md:ml-[-4px]"
                        />
                      </div>
                    </button>
                  );
          ...
          <div className="space-y-2 relative z-10">
            {bookmarks.length === 0 ? (
              <div className="flex flex-col items-center justify-center text-center py-24 px-6 text-[#7f6a55] relative z-10">
                <BookOpen
                  size={48}
                  className="text-[#b88a4f] opacity-35 mb-4 animate-pulse"
                />
                <span className="font-bold text-[14.5px] text-[#2b1a10] mb-1">
                  لا توجد علامات مرجعية محفوظة
                </span>
                <p className="text-[12.5px] max-w-[280px] leading-relaxed opacity-80">
                  أثناء قراءتك للمصحف الشريف، يمكنك حفظ صفحة كاملة أو آية معينة
                  بالضغط عليها لتظهر هنا للرجوع السريع.
                </p>
              </div>
            ) : (
              bookmarks.map((b) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex flex-col text-right">
                        <span className="text-[14px] font-bold text-[#2b1a10] line-clamp-1">
                          سُورَةُ {b.surahName}
                        </span>
                    ...
                    <ChevronLeft
                      size={14}
                      className="text-[#7f6a55]/60 group-hover:text-[#b88a4f] group-hover:-translate-x-0.5 transition-all"
                    />
                  </button>
