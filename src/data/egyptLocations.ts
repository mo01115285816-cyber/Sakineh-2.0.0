...
export const egyptGovernorates: EgyptGovernorate[] = [
  {
    ...
    cities: [
      ...
      { name: "القاهرة الجديدة", lat: 30.03, lon: 31.49 },
    ],
  },
  {
    governorate: "الجيزة",
  ...
  },
  {
    governorate: "الشرقية",
    cities: [
      { name: "الزقازيق", lat: 30.5877, lon: 31.502 },
      ...
      { name: "العاشر من رمضان", lat: 30.3, lon: 31.75 },
    ],
  },
  {
  ...
  },
  {
    ...
    cities: [
      ...
      { name: "المحلة الكبرى", lat: 30.97, lon: 31.1661 },
  ...
  },
  {
    ...
    cities: [
      ...
      { name: "كفر الدوار", lat: 31.135, lon: 30.1333 },
  ...
  },
  {
    ...
    cities: [
      ...
      { name: "السادات", lat: 30.38, lon: 30.5 },
    ],
  },
  {
    governorate: "دمياط",
  ...
  },
  {
    ...
    cities: [
      ...
      { name: "القنطرة شرق", lat: 30.855, lon: 32.3833 },
      { name: "التل الكبير", lat: 30.5631, lon: 31.785 },
    ],
  },
  {
    governorate: "السويس",
    cities: [{ name: "السويس", lat: 29.9668, lon: 32.5498 }],
  },
  {
  ...
  },
  {
    ...
    cities: [
      ...
      { name: "أبو تيج", lat: 27.045, lon: 31.3197 },
  ...
  },
  {
    ...
    cities: [
      ...
      { name: "أبو تشت", lat: 26.06, lon: 32.0886 },
  ...
  },
  {
    ...
    cities: [
      { name: "الخارجة", lat: 25.439, lon: 30.5586 },
      { name: "الداخلة", lat: 25.5, lon: 29.1667 },
  ...
  },
  {
    ...
    cities: [
      ...
      { name: "الضبعة", lat: 31.0264, lon: 28.435 },
  ...
  },
  {
    ...
    cities: [
      ...
      { name: "نويبع", lat: 28.9667, lon: 34.65 },
